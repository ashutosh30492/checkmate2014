...
<html lang="en" class="no-js"> <!--<![endif]-->
    ...
    <body>
        ...
        <div class="container">
            ...
            <br/><h4><a href="Checkmate2014rulebook.pdf" target="_blank">Rulebook</a></h4><br/>
            <section>	
                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
                            ...
                            <form autocomplete="on">
                                <h1>Log in</h1> 
                                <p> 
                                    <label for="username" class="uname" data-icon="u" > Your username <b>&nbsp;&nbsp;<?php global $message; echo $message;?></b></label>
