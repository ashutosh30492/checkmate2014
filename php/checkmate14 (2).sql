...
--
-- Host: localhost
-- Generation Time: Feb 20, 2014 at 08:55 PM
...
INSERT INTO `q_bank` (`q_no`, `level`, `q_content`, `answer`, `base_price`) VALUES
(1, 2, 'asdkjfha;dfhk?', 'asd', 10),
(2, 2, 'adfasfdasdf', 'asd', 12);
...
INSERT INTO `user_point` (`user_id`, `question_array`, `point`, `multipliers`, `multiplier2x`, `multiplier3x`, `multiplier4x`, `multiplier5x`) VALUES
(1, '1000000000000000000000000000000000000000', 66, '2255555555555555555555555555555555555555', -4, 10, 7, 2);
